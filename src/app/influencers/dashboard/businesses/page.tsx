        ...
        <div className="mb-8">
          <div className="flex justify-between items-center">
            <div>
              ...
              <p className="text-xl text-gray-300">Discover authentic African businesses to collaborate with</p>
            </div>
        ...
        {activeTab === 'listings' ? (
          <div className="space-y-6">
            {listings.map((listing) => (
              <Card key={listing.id} className="bg-gray-800 border-yellow-500/30 p-6 hover:shadow-lg transition-all duration-300">
                <div className="flex justify-between items-start mb-4">
                  ...
                  <div className="text-right">
                    <div className="text-2xl font-bold text-yellow-400 mb-1">{listing.price}</div>
                ...
                <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-4 mb-6">
                  <div className="bg-gray-700 rounded-lg p-4">
                    ...
                    <div className="font-semibold text-white">{listing.business}</div>
                  </div>
                  <div className="bg-gray-700 rounded-lg p-4">
                    <div className="text-sm text-gray-400 mb-1">Location</div>
                    <div className="font-semibold text-white">{listing.location}</div>
                  </div>
                  <div className="bg-gray-700 rounded-lg p-4">
                    <div className="text-sm text-gray-400 mb-1">Duration</div>
                    <div className="font-semibold text-white">{listing.duration}</div>
                  </div>
                  <div className="bg-gray-700 rounded-lg p-4">
                    <div className="text-sm text-gray-400 mb-1">Rating</div>
                    <div className="font-semibold text-white">{listing.rating} ({listing.reviews} reviews)</div>
                  </div>
                </div>
          ...
          <div className="space-y-6">
            {applications.map((application) => (
              <Card key={application.id} className="bg-gray-800 border-yellow-500/30 p-6 hover:shadow-lg transition-all duration-300">
                <div className="flex justify-between items-start mb-4">
                  <div>
                    <h3 className="text-xl font-semibold text-white mb-2">{application.listingTitle}</h3>
        ...
        {filteredData.length === 0 && (
          <div className="text-center py-12">
            ...
            <p className="text-gray-300 mb-6">
              {activeTab === 'listings' 
                ? 'No business listings available at the moment. Check back later for new opportunities.'
                : 'You haven\'t applied to any business listings yet.'
              }
            </p>
            {activeTab === 'listings' ? (
              <Link href="/campaigns/new">
