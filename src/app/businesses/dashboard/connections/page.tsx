...
export default function BusinessConnectionsPage() {
  ...
  const connections = [
    {
      ...
      unread: false,
      avatar: 'S',
      booking: 'Maasai Mara Safari - March 15-17'
    },
    {
      id: '2',
      name: 'Mike Chen',
      ...
      unread: true,
      avatar: 'M',
      booking: 'Cultural Village Experience - April 2'
    },
    {
      id: '3',
      name: 'Travel Influencer Pro',
      type: 'Influencer',
      lastMessage: 'I\'d love to collaborate on your safari content.',
      timestamp: '1 day ago',
      unread: false,
      avatar: 'T',
      booking: 'Campaign: Safari Adventure Content'
    }
  ]
  ...
  const recentBookings = [
    ...
    },
    {
      id: '2',
      traveler: 'Mike Chen',
      experience: 'Cultural Village Experience',
      date: 'April 2, 2024',
      status: 'Pending',
      total: 95,
      commission: 14
    ...
    <div className="min-h-screen bg-gradient-to-br from-black via-gray-900 to-black">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className="mb-8">
          ...
          <p className="text-xl text-gray-300">Manage your client relationships and collaborations</p>
        </div>
                    ...
                    <div className="flex items-center justify-between">
                      <div className="flex items-center space-x-4">
                        ...
                        <div>
                          ...
                          <p className="text-gray-400 text-sm">{connection.booking}</p>
                        </div>
                      </div>
                ...
                <Card key={booking.id} className="bg-gray-800 border-yellow-500/30 p-6">
                  <div className="flex justify-between items-start">
                    <div className="flex-1">
                      ...
                      <p className="text-gray-300 mb-2">Client: {booking.traveler}</p>
                    ...
                    <div className="text-right">
                      ...
                      <div className="text-gray-300 text-sm">Commission: ${booking.commission}</div>
