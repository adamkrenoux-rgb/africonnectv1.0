...
export default function BusinessDirectoryPage() {
  ...
  const [sortBy, setSortBy] = useState<'newest' | 'rating' | 'name' | 'views'>(searchParams.get('sort') as any || 'newest')
  ...
  useEffect(() => {
    fetchBusinesses()
  }, [currentPage, searchQuery, selectedCountry, selectedType, verifiedOnly, sortBy])
  ...
  const fetchBusinesses = async () => {
    ...
    try {
      ...
      if (data.success) {
        ...
        // Update URL
        router.push(`/businesses/directory?${params.toString()}`, { scroll: false })
      } else {
